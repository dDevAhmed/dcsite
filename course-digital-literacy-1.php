...
<head>
    ...
    <title>Digital Literacy 1 - Darussalam Computers</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>Digital Literacy 1</span> </li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-3 mb-30">
                            ...
                            <div class="feature-3-info">
                                ...
                                <p>Get ahead in time with the skills needed to thrive in the digital age. Understand the concept of computer application in our daily activities </p>
                                <h4 class="theme-color mt-30">Course Content</h4>
                                <ul class="list list-unstyled theme-color mb-20">
                                    <li> <i class="fa fa-angle-right"></i> Introduction to computer</li>
                                    <li> <i class="fa fa-angle-right"></i> Word processing - MS Word </li>
                                    <li> <i class="fa fa-angle-right"></i> Electronic spreadsheet - MS Excel</li>
                                    <li> <i class="fa fa-angle-right"></i> Presentation - MS Powerpoint</li>
                                    <li> <i class="fa fa-angle-right"></i> Internet application</li>
                                </ul>
                            ...
                            <div class="col-sm-12">
                                ...
                                <form class="form-horizontal" id="contactform" role="form" method="post" action="php/contact-form.php">
                                    <div class=" clearfix">
                                        ...
                                        <div class="section-field mb-20">
                                            <div class="box">
                                                <select class="form-control fancyselect">
                                                    <option>select session*</option>
                                                    <option>Morning 9:00am - 11:00am</option>
                                                    <option>Morning 11:00am - 1:00pm</option>
                                                    <option>Afternoon 1:00pm - 3:00pm</option>
                                                    <option>Afternoon 3:00pm - 5:00pm</option>
                                                </select>
                                            </div>
                                        </div>
