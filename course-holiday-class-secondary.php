...
<head>
    ...
    <title>Holiday Class (Secondary) - Darussalam Computers</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>Holiday Class (Secondary)</span> </li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-3 mb-30">
                            ...
                            <div class="feature-3-info">
                                ...
                                <p>Let your kids spend time learning relevant digital skills. Get them acquainted to the digital opportunities during this holiday. </p>
                                <h4 class="theme-color mt-30">Course Content</h4>
                                <ul class="list list-unstyled theme-color mb-20">
                                    <li> <i class="fa fa-angle-right"></i> Computer basics</li>
                                    <li> <i class="fa fa-angle-right"></i> Internet basics </li>
                                    <li> <i class="fa fa-angle-right"></i> Microsoft Word</li>
                                    <li> <i class="fa fa-angle-right"></i> Microsoft Excel</li>
                                    <li> <i class="fa fa-angle-right"></i> Microsoft powerpoint</li>
                                    <li> <i class="fa fa-angle-right"></i> Audio and video operations</li>
                                    <li> <i class="fa fa-angle-right"></i> Printing basics</li>
                                    <li> <i class="fa fa-angle-right"></i> Graphics - Paint</li>
                                    <li> <i class="fa fa-angle-right"></i> Computer security</li>
                                </ul>
