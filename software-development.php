                                ...
                                <div class="entry-share clearfix">
                                    <div class="social list-style-none pull-right">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#" class="click-to-copy-btn" id="show-copied"><span class="tooltip-content show-copied" data-original-title="copy" data-toggle="tooltip" data-placement="top"> <i class="fa fa-copy"></i> </span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div> 
                                ...
                                <ul class="grid-post">
                                    <li>
                                        <div class="portfolio-item">
                                            <img class="img-responsive" src="images/services/moreservices/software/software-1.jpg" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="portfolio-item">
                                            <img class="img-responsive" src="images/services/moreservices/software/software-2.jpg" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="portfolio-item">
                                            <img class="img-responsive" src="images/services/moreservices/software/software-3.jpg" alt="">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="portfolio-item">
                                            <img class="img-responsive" src="images/services/moreservices/software/software-4.jpg" alt="">
                                        </div>
                                    </li>
                                </ul>
                            </div>
