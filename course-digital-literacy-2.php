...
<head>
    ...
    <title>Digital Literacy 2 - Darussalam Computers</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>Digital Literacy 2</span> </li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-3 mb-30">
                            ...
                            <div class="feature-3-info">
                                ...
                                <p>Improve your productivity by advancing your digital skills relevant to business, academic or personal development </p>
                                <h4 class="theme-color mt-30">Course Content</h4>
                                <ul class="list list-unstyled theme-color mb-20">
                                    <li> <i class="fa fa-angle-right"></i> Microsoft word 2 </li>
                                    <li> <i class="fa fa-angle-right"></i> Microsoft excel 2</li>
                                    <li> <i class="fa fa-angle-right"></i> Microsoft powerpoint 2</li>
                                    <li> <i class="fa fa-angle-right"></i> Microsoft paint</li>
                                </ul>
