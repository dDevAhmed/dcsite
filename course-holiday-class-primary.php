...
<head>
    ...
    <title>Holiday Class (Primary) - Darussalam Computers</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>Holiday Class (Primary)</span> </li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-3 mb-30">
                            ...
                            <div class="feature-3-info">
                                ...
                                <p>Catch them young with the relevant digital skills. Introduce your kids to the digital world by enrolling them in the digital skills holiday class. </p>
                                <h4 class="theme-color mt-30">Course Content</h4>
                                <ul class="list list-unstyled theme-color mb-20">
                                    <li> <i class="fa fa-angle-right"></i> First step with computers </li>
                                    <li> <i class="fa fa-angle-right"></i> Computer basics</li>
                                    <li> <i class="fa fa-angle-right"></i> Text and documents - MS Word</li>
                                    <li> <i class="fa fa-angle-right"></i> Calculations - MS Excel</li>
                                    <li> <i class="fa fa-angle-right"></i> Drawing and paint</li>
