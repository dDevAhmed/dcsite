                        ...
                        <div class="feature-3 mb-30">
                            ...
                            <div class="feature-3-info">
                                ...
                                <ul class="list list-unstyled theme-color mb-20">
                                    <li> <i class="fa fa-angle-right"></i> HTML/CSS </li>
                                    <li> <i class="fa fa-angle-right"></i> Javascript/Jquery</li>
                                    <li> <i class="fa fa-angle-right"></i> PHP</li>
                                    <li> <i class="fa fa-angle-right"></i> MySQL </li>
                                    <li> <i class="fa fa-angle-right"></i> Bootstrap</li>
                                    <li> <i class="fa fa-angle-right"></i> Domain registration/hosting</li>
                                    <li> <i class="fa fa-angle-right"></i> Server installation/management </li>
                                    <li> <i class="fa fa-angle-right"></i> Enterprenuership</li>
                                </ul>
