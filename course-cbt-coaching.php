...
<head>
    ...
    <title>CBT Coaching - Darussalam Computers</title>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="feature-3 mb-30">
                            ...
                            <div class="feature-3-info">
                                ...
                                <p>Get familiarise to computer base test (CBT). Understand the necessary requirements and prepare yourself with a live cbt simulation software </p>
                                <h4 class="theme-color mt-30">Course Content</h4>
                                <ul class="list list-unstyled theme-color mb-20">
                                    <li> <i class="fa fa-angle-right"></i> First step with computer</li>
                                    <li> <i class="fa fa-angle-right"></i> CBT application / software </li>
                                    <li> <i class="fa fa-angle-right"></i> Time management on test</li>
                                    <li> <i class="fa fa-angle-right"></i> Examination day simulation</li>
                                </ul>
